...
// Make changes to WMSkinAssessment.m instead.
...
const struct WMSkinAssessmentFetchedProperties WMSkinAssessmentFetchedProperties = {
};

@implementation WMSkinAssessmentID
@end

@implementation _WMSkinAssessment

+ (id)insertInManagedObjectContext:(NSManagedObjectContext*)moc_ {
	NSParameterAssert(moc_);
	return [NSEntityDescription insertNewObjectForEntityForName:@"WMSkinAssessment" inManagedObjectContext:moc_];
}

+ (NSString*)entityName {
	return @"WMSkinAssessment";
}

+ (NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_ {
	NSParameterAssert(moc_);
	return [NSEntityDescription entityForName:@"WMSkinAssessment" inManagedObjectContext:moc_];
}

- (WMSkinAssessmentID*)objectID {
	return (WMSkinAssessmentID*)[super objectID];
}
