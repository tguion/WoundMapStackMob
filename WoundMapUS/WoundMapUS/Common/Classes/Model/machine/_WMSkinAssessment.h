...
extern const struct WMSkinAssessmentAttributes {
	...
	__unsafe_unretained NSString *wmskinassessment_id;
...
@property (nonatomic, strong) NSString* wmskinassessment_id;



//- (BOOL)validateWmskinassessment_id:(id*)value_ error:(NSError**)error_;
...
- (NSString*)primitiveWmskinassessment_id;
- (void)setPrimitiveWmskinassessment_id:(NSString*)value;
