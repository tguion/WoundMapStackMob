...
// Make changes to WMMedicalHistoryItem.h instead.

#import <CoreData/CoreData.h>


extern const struct WMMedicalHistoryItemAttributes {
...
} WMMedicalHistoryItemAttributes;

extern const struct WMMedicalHistoryItemRelationships {
	__unsafe_unretained NSString *values;
} WMMedicalHistoryItemRelationships;

extern const struct WMMedicalHistoryItemFetchedProperties {
} WMMedicalHistoryItemFetchedProperties;
...
@interface WMMedicalHistoryItemID : NSManagedObjectID {}
@end

@interface _WMMedicalHistoryItem : NSManagedObject {}
+ (id)insertInManagedObjectContext:(NSManagedObjectContext*)moc_;
+ (NSString*)entityName;
+ (NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_;
- (WMMedicalHistoryItemID*)objectID;
...
@interface _WMMedicalHistoryItem (CoreDataGeneratedAccessors)
...
@interface _WMMedicalHistoryItem (CoreDataGeneratedPrimitiveAccessors)
