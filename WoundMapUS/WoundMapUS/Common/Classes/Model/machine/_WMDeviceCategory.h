...
// Make changes to WMDeviceCategory.h instead.

#import <CoreData/CoreData.h>


extern const struct WMDeviceCategoryAttributes {
	...
	__unsafe_unretained NSString *wmdevicecategory_id;
} WMDeviceCategoryAttributes;

extern const struct WMDeviceCategoryRelationships {
	__unsafe_unretained NSString *devices;
	__unsafe_unretained NSString *woundTypes;
} WMDeviceCategoryRelationships;

extern const struct WMDeviceCategoryFetchedProperties {
} WMDeviceCategoryFetchedProperties;
...
@interface WMDeviceCategoryID : NSManagedObjectID {}
@end

@interface _WMDeviceCategory : NSManagedObject {}
...
@property (nonatomic, strong) NSString* wmdevicecategory_id;



//- (BOOL)validateWmdevicecategory_id:(id*)value_ error:(NSError**)error_;
...
@interface _WMDeviceCategory (CoreDataGeneratedAccessors)

- (void)addDevices:(NSSet*)value_;
- (void)removeDevices:(NSSet*)value_;
- (void)addDevicesObject:(WMDevice*)value_;
- (void)removeDevicesObject:(WMDevice*)value_;
...
@interface _WMDeviceCategory (CoreDataGeneratedPrimitiveAccessors)
...
- (NSString*)primitiveWmdevicecategory_id;
- (void)setPrimitiveWmdevicecategory_id:(NSString*)value;
