...
// Make changes to WMInterventionEventType.h instead.

#import <CoreData/CoreData.h>


extern const struct WMInterventionEventTypeAttributes {
	...
	__unsafe_unretained NSString *wminterventioneventtype_id;
} WMInterventionEventTypeAttributes;

extern const struct WMInterventionEventTypeRelationships {
	__unsafe_unretained NSString *interventionEvents;
} WMInterventionEventTypeRelationships;

extern const struct WMInterventionEventTypeFetchedProperties {
} WMInterventionEventTypeFetchedProperties;
...
@interface WMInterventionEventTypeID : NSManagedObjectID {}
@end

@interface _WMInterventionEventType : NSManagedObject {}
...
@property (nonatomic, strong) NSString* wminterventioneventtype_id;



//- (BOOL)validateWminterventioneventtype_id:(id*)value_ error:(NSError**)error_;
...
@interface _WMInterventionEventType (CoreDataGeneratedAccessors)
...
@interface _WMInterventionEventType (CoreDataGeneratedPrimitiveAccessors)
...
- (NSString*)primitiveWminterventioneventtype_id;
- (void)setPrimitiveWminterventioneventtype_id:(NSString*)value;
