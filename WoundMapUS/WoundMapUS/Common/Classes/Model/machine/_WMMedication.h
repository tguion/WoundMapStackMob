...
extern const struct WMMedicationAttributes {
	...
	__unsafe_unretained NSString *wmmedication_id;
...
@property (nonatomic, strong) NSString* wmmedication_id;



//- (BOOL)validateWmmedication_id:(id*)value_ error:(NSError**)error_;
...
- (NSString*)primitiveWmmedication_id;
- (void)setPrimitiveWmmedication_id:(NSString*)value;
