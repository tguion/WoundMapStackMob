...
// Make changes to WMMedication.m instead.
...
const struct WMMedicationFetchedProperties WMMedicationFetchedProperties = {
};

@implementation WMMedicationID
@end

@implementation _WMMedication

+ (id)insertInManagedObjectContext:(NSManagedObjectContext*)moc_ {
	NSParameterAssert(moc_);
	return [NSEntityDescription insertNewObjectForEntityForName:@"WMMedication" inManagedObjectContext:moc_];
}
...
+ (NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_ {
	NSParameterAssert(moc_);
	return [NSEntityDescription entityForName:@"WMMedication" inManagedObjectContext:moc_];
}

- (WMMedicationID*)objectID {
	return (WMMedicationID*)[super objectID];
}
