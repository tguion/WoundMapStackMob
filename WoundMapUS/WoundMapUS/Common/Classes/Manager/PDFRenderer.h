...
@class WMWoundTreatmentGroup, WMWoundTreatment, WMMedicationGroup, WMDeviceGroup, WMPsychoSocialGroup, WMSkinAssessmentGroup, WMCarePlanGroup, WMCarePlanCategory, WMWoundMeasurementGroup;
...
@property (strong, nonatomic) WMPatient *patient;                       // patient whos data is being rendered
@property (strong, nonatomic) WMWound *wound;                           // current patient wound data is being rendered
...
// all graphable data for current patient/woundPhoto - map for WMWoundMeasurement.title to map of key -> WoundStatusMeasurementRollup instances
...
- (CGFloat)drawPatientWoundHeader:(WMWound *)wound inRect:(CGRect)rect draw:(BOOL)draw;
- (CGFloat)drawWoundSummaryForWound:(WMWound *)wound inRect:(CGRect)rect draw:(BOOL)draw;
- (CGFloat)drawWoundPhoto:(WMWoundPhoto *)woundPhoto inRect:(CGRect)rect;
...
- (CGFloat)drawWoundTreatmentForWound:(WMWound *)wound inRect:(CGRect)rect draw:(BOOL)draw;
- (CGFloat)drawWoundTreatment:(WMWoundTreatmentGroup *)woundTreatmentGroup inRect:(CGRect)aFrame draw:(BOOL)draw;
