...
@property (strong, nonatomic) NSArray *plotDataSources;                 // one for each WMWoundMeasurement
...
@property (strong, nonatomic) NSMutableDictionary *key2RollupMap;       // selected WMWoundMeasurement.title or Braden Scale data
...
- (CGFloat)drawPatientWoundHeader:(WMWound *)wound inRect:(CGRect)aFrame draw:(BOOL)draw
{
    CGFloat x = CGRectGetMinX(aFrame);
    CGFloat y = CGRectGetMinY(aFrame);
    // size headings
...
- (CGFloat)drawWoundSummaryForWound:(WMWound *)wound inRect:(CGRect)aFrame draw:(BOOL)draw
{
...
- (CGFloat)drawWoundPhoto:(WMWoundPhoto *)woundPhoto inRect:(CGRect)aFrame
{
...
- (CGFloat)drawWoundTreatmentForWound:(WMWound *)wound inRect:(CGRect)aFrame draw:(BOOL)draw
{
