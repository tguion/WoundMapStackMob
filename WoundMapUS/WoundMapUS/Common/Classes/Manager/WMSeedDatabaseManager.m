...
//        [WCMedicationCategory seedDatabase:managedObjectContext persistentStore:nil];
//        [WCDeviceCategory seedDatabase:managedObjectContext persistentStore:nil];
//        [WCSkinAssessmentCategory seedDatabase:managedObjectContext persistentStore:nil];
//        [WCCarePlanCategory seedDatabase:managedObjectContext persistentStore:nil];
//        [WCWoundLocation seedDatabase:managedObjectContext persistentStore:nil];
//        [WCWoundTreatment seedDatabase:managedObjectContext persistentStore:nil];
//        [WCWoundMeasurement seedDatabase:managedObjectContext persistentStore:nil];
