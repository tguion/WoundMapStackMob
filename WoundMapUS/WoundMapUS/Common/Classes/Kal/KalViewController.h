...
// designated initializer. When the calendar is first displayed to the user,
// the month that contains 'selectedDate' will be shown and the corresponding tile for 'selectedDate' will be automatically selected.
