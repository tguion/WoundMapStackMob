...
- (void)viewDidLoad
{
    ...
    [ff getArrayFromUri:[NSString stringWithFormat:@"%@/%@?depthGb=1&depthRef=1", patient.ffUrl, WMPatientRelationships.carePlanGroups] onComplete:^(NSError *error, id object, NSHTTPURLResponse *response) {
        if (error) {
