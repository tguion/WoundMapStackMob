...
- (void)viewDidLoad
{
    ...
    [ff getObjFromUri:[NSString stringWithFormat:@"%@/%@?depthGb=1&depthRef=1", patient.ffUrl, WMPatientRelationships.nutritionGroups] onComplete:^(NSError *error, id object, NSHTTPURLResponse *response) {
